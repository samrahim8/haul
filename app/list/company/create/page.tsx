...
import type { Company, Sale, SaleInsert } from "@/lib/database.types";
...
export default function CreateCompanySalePage() {
  ...
  useEffect(() => {
    ...
    async function checkAuth() {
      ...
      if (!session) {
        router.push("/signin?redirect=/list/company/create");
        return;
      }
      ...
      <main className="px-4 py-8 sm:px-6 sm:py-12 md:py-16">
        <div className="mx-auto max-w-2xl">
          ...
          <p className="mt-2 text-[#6B7280]">
            Listing as <span className="font-medium text-[#2D3B2D]">{company?.company_name}</span>
          </p>
